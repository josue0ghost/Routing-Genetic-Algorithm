...
class Point_of_Sale:
  def __init__(self, name, latitude, longitude, address="",
    ...
    # Set POS total time
    self.total_time = entree_time + unloading_time + checkout_time \
      + (journey2pos_time + delivery_time + journey2unloadingpoint_time)*self.num_travels \
      + extra_times
